...
// Γòæ  PORTFOLIO DATA ΓÇö Edit this file to update your portfolio  Γòæ
...
//
//  Γ£Å∩╕Å  Just change the values below and redeploy.
//      No need to touch HTML, CSS, or any other file.

const PORTFOLIO = {

  // ΓöÇΓöÇ Personal Info ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  name: "Nikhil Pathak",
  ...
  heroDescription:
    "I'm Nikhil Pathak ΓÇö a Certified Scrum Master (PSM I) and AI Product Builder with 7+ years shipping Agile delivery across e-commerce, fitness CRM, and Agentic AI domains. I bridge product strategy, delivery velocity, and hands-on AI development ΓÇö from sprint board to production deployment.",

  // ΓöÇΓöÇ At a Glance Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  glance: [
    { label: "Location", value: "Gurugram, India" },
    { label: "Certification", value: "PSM I ΓÇö Scrum.org" },
  ...
  // ΓöÇΓöÇ Skills / Expertise ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  skillsSectionTitle: "Four disciplines,",
  skillsSectionEmphasis: "one direction.",
  skillsSectionDesc:
    "Operating at the crossroads of product strategy, agile delivery, and hands-on AI product development ΓÇö across e-commerce, CRM, and Agentic AI domains.",
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        "Defining and shipping AI products end-to-end ΓÇö from problem discovery and roadmap through to LLM integration, voice agent development, and production deployment on modern cloud stacks.",
    ...
    },
    {
      ...
      description:
        "Hands-on across the full delivery stack ΓÇö from sprint boards to production. Comfortable wiring backends, auth flows, deployments, and AI pipelines without waiting for dev bandwidth.",
      tags: ["GitHub", "Firebase", "OAuth", "Vercel", "Railway", "Supabase (PostgreSQL)", "GCP", "n8n"],
    },
  ],

  // ΓöÇΓöÇ Tools Stack ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  // Grouped by category ΓÇö use this for a dedicated Tools section in the portfolio
  toolStack: {
  ...
  // ΓöÇΓöÇ Experience / Timeline ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  experience: [
    {
      ...
      points: [
        ...
        "Partnered with stakeholders to define product roadmaps tied to business OKRs ΓÇö increased feature delivery predictability by 30% and reduced misaligned scope.",
        "Integrated AI-assisted workflows into sprint ceremonies ΓÇö LLM tools for auto-generating user stories, summarising retro themes, and flagging delivery risks early.",
        "Built and shipped Agentic AI product prototypes using n8n automation, voice agents, and LLM integrations ΓÇö deployed on Railway and Vercel with Supabase backends.",
    ...
    },
    {
      ...
      points: [
        "Managed 2 concurrent Agile teams (8ΓÇô10 members each) in the banking domain; maintained 100% sprint cadence adherence for 3+ years.",
        "Contributed to product strategy sessions ΓÇö translating stakeholder goals into prioritised backlogs and measurable OKRs across multiple product lines.",
  ...
  // ΓöÇΓöÇ Projects ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  projectsSectionTitle: "Built with",
  projectsSectionEmphasis: "AI & intent.",
  projectsSectionDesc:
    "Products and tools I've shipped across Agentic AI, e-commerce, fitness CRM, and Agile delivery ΓÇö from idea to production.",

  projects: [
    {
      badge: "Agentic AI",
      glyph: "V",
      title: "Voice Agent ΓÇö Agentic AI Product",
      description:
        "An end-to-end Agentic AI product with a voice interface, LLM reasoning layer, and n8n automation backend. Handles multi-step tasks autonomously ΓÇö deployed on Railway with a Supabase PostgreSQL store.",
    ...
    },
    {
      ...
      description:
        "An LLM-powered assistant embedded in Agile workflows ΓÇö summarises retro themes, flags at-risk tickets, and drafts sprint goals from raw team input. Integrated with Jira API.",
    ...
    },
    {
      badge: "Fitness CRM",
      glyph: "F",
      title: "Fitness Industry CRM ΓÇö Delivery Lead",
      description:
    ...
    },
    {
      ...
      description:
        "Paste a job description, get keyword suggestions and an ATS score back ΓÇö built with prompt engineering to solve my own job search problem.",
    ...
    },
    {
      ...
      description:
        "Converts raw feature requests and product strategy inputs into formatted user stories with acceptance criteria ΓÇö in seconds. Wired directly to Jira via API.",
      stack: ["LLM", "Jira API", "n8n", "Automation"],
      domain: "Agile ┬╖ Productivity",
    },
  ],

  // ΓöÇΓöÇ Certifications ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  certsSectionTitle: "Certifications &",
  certsSectionEmphasis: "continuous learning.",

  certifications: [
    {
      title: "PSM I ΓÇö Professional Scrum Master",
  ...
  // ΓöÇΓöÇ Contact ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
